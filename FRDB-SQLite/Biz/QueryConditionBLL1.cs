...
{
    public class QueryConditionBLL1
    {
        #region 1. Fields
        ...
        private FzRelationEntity _selectedRelations;
        ...
        public FzRelationEntity SelectedRelations
        {
        ...
        public QueryConditionBLL1() { }

        public QueryConditionBLL1(List<Item> items, FzRelationEntity sets)
        {
            ...
            this._attributes = sets.Scheme.Attributes;
        }
